    ...
    <div class="index-hover row col-lg-9 col-xl-11 justify-content-end">
        ...
        <div class="index-nhover card index-card mr-1 mt-1" style="width: 12.0rem">
            ...
            <img class="card-img-top index-img-card" src="{{asset('img/Cards/Lungo Origin Guatemala.webp')}}"
                        ...
                        <div class="index-nhover card index-card mr-1 mt-1" style="width: 10.0rem">
                            <img class="card-img-top index-img-card" src="{{asset('img/Cards/Espresso Leggero.webp')}}"
                                alt="Imagem de capa do card">
                            <div class="card-body pt-1 px-3">
                        ...
                        <div class="index-nhover card index-card mr-1 mt-1" style="width: 10.0rem">
                            <img class="card-img-top index-img-card" src="{{asset('img/Cards/Expresso Caramel.webp')}}"
                                alt="Imagem de capa do card">
                            <div class="card-body pt-1 px-3">
                        ...
                        <div class="index-nhover card index-card mr-1 mt-1" style="width: 10.0rem">
                            <img class="card-img-top index-img-card" src="{{asset('img/Cards/Restretto.webp')}}"
                                alt="Imagem de capa do card">
                            <div class="card-body pt-1 px-3">
                        ...
                        <div class="index-nhover card index-card mr-1 mt-1" style="width: 10.0rem">
                            <img class="card-img-top index-img-card" src="{{asset('img/Cards/Lungo Forte.webp')}}"
                                alt="Imagem de capa do card">
                            <div class="card-body pt-1 px-3">
                        ...
                        <div class="index-nhover card index-card mr-1 mt-1" style="width: 10.0rem">
                            <img class="card-img-top index-img-card" src="{{asset('img/Cards/Espresso Forte.webp')}}"
                                alt="Imagem de capa do card">
                            <div class="card-body pt-1 px-3">
                        ...
                        <div class="index-nhover card index-card mr-1 mt-1" style="width: 10.0rem">
                            <img class="card-img-top index-img-card" src="{{asset('img/Cards/Espresso Vanilla.webp')}}"
                                alt="Imagem de capa do card">
                            <div class="card-body pt-1 px-3">
